...
public class FormulaProcessor2Tests
{
    ...
    [TestCase(@"IIF(""R1C1"" > 10, 1, 2) + SUM(""R4C5:R4C8"") + SUM(""R4C5:R4C8"")", @"IIF(""R1C1"" > 10, 1, 2) + SUM(""R4C5:R4C8"") + SUM(""R4C5:R4C8"")")]
    ...
    public void Process_Tests(string formulaIn, string expected)
    {
        ...
        var formulaOut = builder.Process(new StringBuilder(formulaIn));
